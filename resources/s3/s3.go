...
func (s *S3Stack) CreateStorageBucket(certificate awscertificatemanager.ICertificate, vpc awsec2.IVpc, lambdaenv map[string]string) (awscloudfront.OriginAccessIdentity, awscloudfront.PublicKey) {
